...
describe('slack', () => {
  describe('convertMarkdownToSlack', () => {
    it('should convert commit links to Slack format', () => {
      ...
      expect(result).toBe(`<${REPO_URL}/commit/f09968a|f09968a> - chore: copy change by @ThomasRalee`);
    });
  ...
  describe('buildDeploymentPayload', () => {
    ...
    it('should build payload for deployment with new commits', () => {
      ...
      expect(payload.text).toContain(`<${REPO_URL}/commit/${REAL_COMMITS.copyChange.hash}|f09968a>`);
  ...
  describe('sendSlackNotification', () => {
    ...
    it('should throw error on non-ok response', async () => {
      ...
      await expect(sendSlackNotification(webhookUrl, payload))
